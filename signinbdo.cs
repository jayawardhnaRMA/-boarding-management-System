...
{
    public partial class signinbdo : Form
    {
        ...
        private void signinbtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string checkQuery = "SELECT COUNT(*) FROM owner WHERE Username = @Username";
                ...
                string insertQuery = "INSERT INTO owner (Username, Password) VALUES (@Username, @Password)";
        ...
        private void signinbdo_Load(object sender, EventArgs e)
        {
